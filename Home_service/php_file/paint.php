...
// }
   ...
   ?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6" style="margin-top:120px;text-align: center;"><span class="alert alert-danger" style="font-weight: bolder;font-size:32px;font-style:italic;">PAINT
...
<div style="margin-top:100px;">
  ...
  <ul class="list-group">
    <li class="list-group-item d-flex justify-content-between align-items-center">
     1-Room-Painting
      <span class="badge badge-primary badge-pill">Rs-1300</span>
    </li>
    <li class="list-group-item d-flex justify-content-between align-items-center">
    Full-2bhk-Flat-Paint
      <span class="badge badge-primary badge-pill">Rs-3300</span>
    </li>
    <li class="list-group-item d-flex justify-content-between align-items-center">
      Full-3bhk-flat-Paint
      <span class="badge badge-primary badge-pill">Rs-5700</span>
      <li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
          ...
          <span class="badge badge-primary badge-pill">Rs-900 per_day</span>
    </li>
    <!-- <li class="list-group-item d-flex justify-content-between align-items-center">
...
<div class="col-sm-6 d-block mx-auto" style=" text-align: justify ; ">           
  ...
  A home paint service offers professional painting services for residential properties. Whether you want to refresh the appearance of your home, change the color scheme, or tackle a renovation project, hiring a professional painting service can ensure a high-quality and efficient paint job. Skilled painters will handle all aspects of the painting process, from surface preparation to applying the final coat of paint.
    ...
    <div style="margin-top:200px; text-align:center;">
       <h4>Faq</h4>
       <div id="accordion" style="margin-top:70px;">
        <div class="row">
          <div class="col">
        <div class="card">
