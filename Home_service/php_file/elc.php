...
// }
   ...
   ?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6" style="margin-top:200px;text-align: center;"><span class="alert alert-danger" style="font-weight: bolder;font-size:32px;font-style:italic;">Electronics-Repair
...
<div style="margin-top: 150px;">
  ...
  <ul class="list-group">
    <li class="list-group-item d-flex justify-content-between align-items-center">
     AC Repair
      <span class="badge badge-primary badge-pill">Rs-741</span>
    </li>
    <li class="list-group-item d-flex justify-content-between align-items-center">
      COOLER-REPAIR
      <span class="badge badge-primary badge-pill">Rs-400</span>
    </li>
    <li class="list-group-item d-flex justify-content-between align-items-center">
      FANS
      ...
      <li class="list-group-item d-flex justify-content-between align-items-center">
        INDUCTIONS
        <span class="badge badge-primary badge-pill">After-Visit</span>
        <li class="list-group-item d-flex justify-content-between align-items-center">
...
<li class="list-group-item d-flex justify-content-between align-items-center">
  MICROWAVE
    ...
    <span class="badge badge-primary badge-pill">Rs On-Inspection</span>
  </li>
  <li class="list-group-item d-flex justify-content-between align-items-center">
    MIXER-GRINDER
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center">
      ...
      <li class="list-group-item d-flex justify-content-between align-items-center">
        RO-PURIFIER
          ...
          <span class="badge badge-primary badge-pill">Rs-300</span>
        </li>
        <li class="list-group-item d-flex justify-content-between align-items-center">
          SWITCH BOARDS
          
            <span class="badge badge-primary badge-pill">Rs-101</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
            WASHING MACHINE
...
<div class="col-sm-6" style=" text-align: justify ; ">           
  ...
  A home electronic repair service offers the convenience of having your electronic devices repaired in the comfort of your own home. Instead of taking your devices to a repair shop, a technician will visit your residence to diagnose and fix the issues on-site. This type of service is particularly beneficial for larger devices, such as televisions, home theater systems, or appliances that are difficult to transport.
</p>
